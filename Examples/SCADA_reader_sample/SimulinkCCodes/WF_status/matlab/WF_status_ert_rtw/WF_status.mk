...
COMPILER_COMMAND_FILE     = WF_status_comp.rsp
CMD_FILE                  = WF_status.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\WF_status.exe
...
DEFINES_STANDARD = -DMODEL=WF_status -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\WF_status_ert_rtw\WF_status.c

MAIN_SRC = $(START_DIR)\WF_status_ert_rtw\ert_main.c
...
{$(START_DIR)\WF_status_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\WF_status_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
WF_status.obj : "$(START_DIR)\WF_status_ert_rtw\WF_status.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\WF_status_ert_rtw\WF_status.c"


ert_main.obj : "$(START_DIR)\WF_status_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\WF_status_ert_rtw\ert_main.c"
