...
/* Project includes */
#include "loadsprc.h"
#include "loadsprc_e.h"
#include "loadsprc_int.h"
...
SINT32  loadsprc_AppEOI(VOID);
VOID    loadsprc_AppDeinit(VOID);
SINT32  loadsprc_CfgRead(VOID);
SINT32  loadsprc_SviSrvInit(VOID);
VOID    loadsprc_SviSrvDeinit(VOID);

/* Functions: administration, to be called only from within this file */
MLOCAL VOID loadsprc_CfgInit(VOID);
...
LOADSPRC_BASE_PARMS loadsprc_BaseParams;
...
REAL64 host_scada_wt1blade1rootflap[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade1rootflap;
REAL64 host_scada_wt1blade1rootedge[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade1rootedge;
REAL64 host_scada_WT3PitchAngle1[1];
MLOCAL SVI_ADDR SA_host_scada_WT3PitchAngle1;
REAL64 host_scada_wt1blade2rootflap[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade2rootflap;
REAL64 host_scada_wt1blade2rootedge[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade2rootedge;
REAL64 host_scada_WT3PitchAngle2[1];
MLOCAL SVI_ADDR SA_host_scada_WT3PitchAngle2;
REAL64 host_scada_wt1blade3rootflap[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade3rootflap;
REAL64 host_scada_wt1blade3rootedge[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade3rootedge;
REAL64 host_scada_WT3PitchAngle3[1];
MLOCAL SVI_ADDR SA_host_scada_WT3PitchAngle3;
REAL64 host_scada_wt1blade1IP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade1IP;
REAL64 host_scada_wt1blade2IP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade2IP;
REAL64 host_scada_wt1blade3IP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade3IP;
REAL64 host_scada_wt1blade1OOP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade1OOP;
REAL64 host_scada_wt1blade2OOP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade2OOP;
REAL64 host_scada_wt1blade3OOP[1];
MLOCAL SVI_ADDR SA_host_scada_wt1blade3OOP;
...
MLOCAL REAL64 b1_flap=0;
MLOCAL REAL64 b1_edge=0;
MLOCAL REAL64 b1_pitch=0;
MLOCAL REAL64 b2_flap=0;
MLOCAL REAL64 b2_edge=0;
MLOCAL REAL64 b2_pitch=0;
MLOCAL REAL64 b3_flap=0;
MLOCAL REAL64 b3_edge=0;
MLOCAL REAL64 b3_pitch=0;
MLOCAL REAL64 b1_oop=0;
MLOCAL REAL64 b1_ip=0;
MLOCAL REAL64 b2_oop=0;
MLOCAL REAL64 b2_ip=0;
MLOCAL REAL64 b3_oop=0;
MLOCAL REAL64 b3_ip=0;
...
MLOCAL TASK_PROPERTIES TaskProperties_aControl = {
    "aLOADSPRC_Ctrl",                 /* unique task name, maximum length 14 */
...
MLOCAL SVI_GLOBVAR SviGlobVarList[] = {
    {"CycleCounter", SVI_F_INOUT | SVI_F_UINT32, sizeof(UINT32), (UINT32 *) & CycleCount, 0, NULL,
     NULL}
    ,
    {"ModuleVersion", SVI_F_OUT | SVI_F_STRING, sizeof(loadsprc_Version),
     (UINT32 *) loadsprc_Version, 0, NULL, NULL},

// MATLABCODEGEN: OpenField SVI Variables Coupling

{"b1_flap", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b1_flap, 0, NULL, NULL},
{"b1_edge", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b1_edge, 0, NULL, NULL},
{"b1_pitch", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b1_pitch, 0, NULL, NULL},
{"b2_flap", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b2_flap, 0, NULL, NULL},
{"b2_edge", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b2_edge, 0, NULL, NULL},
{"b2_pitch", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b2_pitch, 0, NULL, NULL},
{"b3_flap", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b3_flap, 0, NULL, NULL},
{"b3_edge", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b3_edge, 0, NULL, NULL},
{"b3_pitch", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b3_pitch, 0, NULL, NULL},
{"b1_oop", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b1_oop, 0, NULL, NULL},
{"b1_ip", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b1_ip, 0, NULL, NULL},
{"b2_oop", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b2_oop, 0, NULL, NULL},
{"b2_ip", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b2_ip, 0, NULL, NULL},
{"b3_oop", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b3_oop, 0, NULL, NULL},
{"b3_ip", SVI_F_INOUT | SVI_F_BLK | SVI_F_REAL64, sizeof(REAL64[1]), (UINT32 *) &b3_ip, 0, NULL, NULL},
...
b1_flap = host_scada_wt1blade1rootflap[0];
b1_edge = host_scada_wt1blade1rootedge[0];
b1_pitch = host_scada_WT3PitchAngle1[0];
b2_flap = host_scada_wt1blade2rootflap[0];
b2_edge = host_scada_wt1blade2rootedge[0];
b2_pitch = host_scada_WT3PitchAngle2[0];
b3_flap = host_scada_wt1blade3rootflap[0];
b3_edge = host_scada_wt1blade3rootedge[0];
b3_pitch = host_scada_WT3PitchAngle3[0];
...
loads_process_U.b1_flap =  b1_flap;
loads_process_U.b1_edge =  b1_edge;
loads_process_U.b1_pitch =  b1_pitch;
loads_process_U.b2_flap =  b2_flap;
loads_process_U.b2_edge =  b2_edge;
loads_process_U.b2_pitch =  b2_pitch;
loads_process_U.b3_flap =  b3_flap;
loads_process_U.b3_edge =  b3_edge;
loads_process_U.b3_pitch =  b3_pitch;
...
b1_oop =  loads_process_Y.b1_oop;
b1_ip =  loads_process_Y.b1_ip;
b2_oop =  loads_process_Y.b2_oop;
b2_ip =  loads_process_Y.b2_ip;
b3_oop =  loads_process_Y.b3_oop;
b3_ip =  loads_process_Y.b3_ip;

// MATLABCODEGEN: CloseField Output Variable Assignment

// MATLABCODEGEN: OpenField Assign ITF output Variables to HOST SVI

host_scada_wt1blade1IP[0] = b1_oop;
host_scada_wt1blade2IP[0] = b1_ip;
host_scada_wt1blade3IP[0] = b2_oop;
host_scada_wt1blade1OOP[0] = b2_ip;
host_scada_wt1blade2OOP[0] = b3_oop;
host_scada_wt1blade3OOP[0] = b3_ip;
...
SINT32 loadsprc_AppEOI(VOID)
{
    ...
    do
    {
        ...
        snprintf(loadsprc_ModuleInfoDesc, sizeof(loadsprc_ModuleInfoDesc), "TODO: set application specific module info string");
...
*        For general configuration data, loadsprc_CfgParams is being used.
*        Being called by loadsprc_CfgRead.
...
MLOCAL SINT32 Task_CfgRead(VOID)
{
    ...
    snprintf(section, sizeof(section), loadsprc_BaseParams.AppName);
    ...
    for (idx = 0; idx < NbOfTasks; idx++)
    {
        ...
        ret = pf_GetStrg(section, group, key, "", (CHAR *) & TmpStrg, sizeof(TmpStrg),
                         loadsprc_BaseParams.CfgLine, loadsprc_BaseParams.CfgFileName);
        ...
        else
        {
            ...
            {
                TaskList[idx]->Priority = loadsprc_BaseParams.DefaultPriority;
...
MLOCAL SINT32 Task_CreateAll(VOID)
{
    ...
    for (idx = 0; idx < NbOfTasks; idx++)
    {
        ...
        if (TaskList[idx]->WDogRatio > 0)
        {
            ...
            TaskList[idx]->WdogId = sys_WdogCreate(loadsprc_AppName, wdogtime_us);
        ...
        if (strlen(TaskList[idx]->Name) < 1)
            snprintf(TaskList[idx]->Name, sizeof(TaskList[idx]->Name), "a%s_%d", loadsprc_AppName, idx + 1);
        ...
        TaskList[idx]->TaskId = sys_TaskSpawn(loadsprc_AppName, TaskName,
...
MLOCAL VOID Task_DeleteAll(VOID)
{
    ...
    do
    {
        ...
        if (AllTasksQuitted)
        {
            if (loadsprc_BaseParams.DebugMode & APP_DBG_INFO1)
...
MLOCAL SINT32 Task_InitTiming_Sync(TASK_PROPERTIES * pTaskData)
{
    ...
    pTaskData->SyncSessionId = mio_StartSyncSession(loadsprc_AppName);
...
MLOCAL VOID Task_WaitCycle(TASK_PROPERTIES * pTaskData)
{
     ...
     */
    if ((loadsprc_ModState == RES_S_STOP) || (loadsprc_ModState == RES_S_EOI))
    {
         ...
         */
        semTake(loadsprc_StateSema, WAIT_FOREVER);
    }
}
...
MLOCAL VOID loadsprc_CfgInit(VOID)
{
    ...
    strncpy(loadsprc_BaseParams.CfgFileName, loadsprc_ProfileName, M_PATHLEN);

    /* Application name */
    strncpy(loadsprc_BaseParams.AppName, loadsprc_AppName, M_MODNAMELEN);

    /* Line number in configuration file (used as start line for searching) */
    loadsprc_BaseParams.CfgLine = loadsprc_CfgLine;

    /* Worker task priority from module base parameters (BaseParms) */
    loadsprc_BaseParams.DefaultPriority = loadsprc_AppPrio;

    /* Debug mode from module base parameters (BaseParms) */
    loadsprc_BaseParams.DebugMode = loadsprc_Debug;
...
SINT32 loadsprc_SviSrvInit(VOID)
{
    ...
    UINT32  i;
    CHAR    Func[] = "loadsprc_SviSrvInit";

    /* If there are any SVI variables to be exported */
    if (NbOfGlobVars)
    {
        /* Initialize SVI-handler */
        loadsprc_SviHandle = svi_Init(loadsprc_AppName, 0, 0);
        if (!loadsprc_SviHandle)
        {
    ...
    {
        ret = svi_AddGlobVar(loadsprc_SviHandle, SviGlobVarList[i].VarName,
...
/**
********************************************************************************
* @brief Frees SVI server resources according to loadsprc_SviSrvInit()
...
VOID loadsprc_SviSrvDeinit(VOID)
{
    ...
    if (svi_DeInit(loadsprc_SviHandle) < 0)
        LOG_E(0, "loadsprc_SviSrvDeinit", "Could not de-initialize SVI server");
...
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade1_root_flap", &SA_host_scada_wt1blade1rootflap, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade1rootflap!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade1_root_edge", &SA_host_scada_wt1blade1rootedge, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade1rootedge!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "WT3_PitchAngle1", &SA_host_scada_WT3PitchAngle1, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_WT3PitchAngle1!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade2_root_flap", &SA_host_scada_wt1blade2rootflap, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade2rootflap!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade2_root_edge", &SA_host_scada_wt1blade2rootedge, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade2rootedge!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "WT3_PitchAngle2", &SA_host_scada_WT3PitchAngle2, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_WT3PitchAngle2!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade3_root_flap", &SA_host_scada_wt1blade3rootflap, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade3rootflap!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade3_root_edge", &SA_host_scada_wt1blade3rootedge, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade3rootedge!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "WT3_PitchAngle3", &SA_host_scada_WT3PitchAngle3, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_WT3PitchAngle3!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade1_IP", &SA_host_scada_wt1blade1IP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade1IP!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade2_IP", &SA_host_scada_wt1blade2IP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade2IP!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade3_IP", &SA_host_scada_wt1blade3IP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade3IP!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade1_OOP", &SA_host_scada_wt1blade1OOP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade1OOP!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade2_OOP", &SA_host_scada_wt1blade2OOP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade2OOP!");
    return (ERROR);
}
if (svi_GetAddr(pSviLib_hstscada, "wt1_blade3_OOP", &SA_host_scada_wt1blade3OOP, &SviFormat) != SVI_E_OK)
{
    LOG_W(0, Func, "Could not get address of value host_scada_wt1blade3OOP!");
    return (ERROR);
}

// MATLABCODEGEN: CloseField Get ITF SA Address

if (svi_GetAddr(pSviLib_hstscada, "loads_process_AppStatus", &SA_AppStatus, &SviFormat) != SVI_E_OK)
{
...
UINT32 host_scada_wt1blade1rootflap_size = sizeof(host_scada_wt1blade1rootflap);
UINT32 host_scada_wt1blade1rootedge_size = sizeof(host_scada_wt1blade1rootedge);
UINT32 host_scada_WT3PitchAngle1_size = sizeof(host_scada_WT3PitchAngle1);
UINT32 host_scada_wt1blade2rootflap_size = sizeof(host_scada_wt1blade2rootflap);
UINT32 host_scada_wt1blade2rootedge_size = sizeof(host_scada_wt1blade2rootedge);
UINT32 host_scada_WT3PitchAngle2_size = sizeof(host_scada_WT3PitchAngle2);
UINT32 host_scada_wt1blade3rootflap_size = sizeof(host_scada_wt1blade3rootflap);
UINT32 host_scada_wt1blade3rootedge_size = sizeof(host_scada_wt1blade3rootedge);
UINT32 host_scada_WT3PitchAngle3_size = sizeof(host_scada_WT3PitchAngle3);
...
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade1rootflap, (UINT32*) &host_scada_wt1blade1rootflap,  &host_scada_wt1blade1rootflap_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade1rootflap!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade1rootedge, (UINT32*) &host_scada_wt1blade1rootedge,  &host_scada_wt1blade1rootedge_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade1rootedge!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_WT3PitchAngle1, (UINT32*) &host_scada_WT3PitchAngle1,  &host_scada_WT3PitchAngle1_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_WT3PitchAngle1!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade2rootflap, (UINT32*) &host_scada_wt1blade2rootflap,  &host_scada_wt1blade2rootflap_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade2rootflap!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade2rootedge, (UINT32*) &host_scada_wt1blade2rootedge,  &host_scada_wt1blade2rootedge_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade2rootedge!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_WT3PitchAngle2, (UINT32*) &host_scada_WT3PitchAngle2,  &host_scada_WT3PitchAngle2_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_WT3PitchAngle2!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade3rootflap, (UINT32*) &host_scada_wt1blade3rootflap,  &host_scada_wt1blade3rootflap_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade3rootflap!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_wt1blade3rootedge, (UINT32*) &host_scada_wt1blade3rootedge,  &host_scada_wt1blade3rootedge_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_wt1blade3rootedge!");
ret = svi_GetBlk(pSviLib_hstscada, SA_host_scada_WT3PitchAngle3, (UINT32*) &host_scada_WT3PitchAngle3,  &host_scada_WT3PitchAngle3_size);
if (ret != SVI_E_OK)
   LOG_W(0, "SviClt_Read", "Could not read value host_scada_WT3PitchAngle3!");
...
ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade1IP, (UINT32*) &host_scada_wt1blade1IP, sizeof(host_scada_wt1blade1IP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade1IP!");

ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade2IP, (UINT32*) &host_scada_wt1blade2IP, sizeof(host_scada_wt1blade2IP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade2IP!");

ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade3IP, (UINT32*) &host_scada_wt1blade3IP, sizeof(host_scada_wt1blade3IP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade3IP!");

ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade1OOP, (UINT32*) &host_scada_wt1blade1OOP, sizeof(host_scada_wt1blade1OOP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade1OOP!");

ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade2OOP, (UINT32*) &host_scada_wt1blade2OOP, sizeof(host_scada_wt1blade2OOP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade2OOP!");

ret = svi_SetBlk(pSviLib_hstscada, SA_host_scada_wt1blade3OOP, (UINT32*) &host_scada_wt1blade3OOP, sizeof(host_scada_wt1blade3OOP) );
if (ret != SVI_E_OK)
     LOG_W(0, "SviClt_Write", "Could not read value host_scada_wt1blade3OOP!");
